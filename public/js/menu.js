...
function disp(){
  ...
  $.ajax({
    ...
    url : window.location.origin+"/user/restaurant/reitems",
    ...
    success: function(res){
      ...
      $.each(res, function(i, item){
        dd+="<div class='col-md-4 my-3 my-md-0'><div class='testmonial-card'><h3 class='testmonial-title'>"+item.revname+"</h3><div class='testmonial-body'><p>"+item.revcontent+"</p></div></div></div>"
        if(c%3==0)  
        {
          $('#testmonial').append("<div class='row mt-3 mb-5'>"+dd+"</div>")
          dd="";
          c+=1;
        }
          c+=1;
...
function disp2(){
  ...
  $.ajax({
    ...
    success: function(res){
      $.each(res,function(i,item){
        var dd="";
        dd+="<tr><td>"+item._id+"</td><td>"+item.total+"</td></tr>";
      });
      $('#revrat').append(dd)
    },
    error : function(e) {
