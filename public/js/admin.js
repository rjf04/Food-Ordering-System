...
//Function  for review rating display
function ajaxDispRevRat(){  
  // DO POST
  $.ajax({
    type : "POST",
    contentType : "application/json",
    url : window.location.origin + "/user/restaurant/rediitems",
    data : JSON.stringify(''),
    dataType : 'json',
    ...
    success: function(result){
      $.each(result, function(i, item){
        ...
        var dd="";
        dd+="<tr><td> "+item._id + "</td>";

        if(item.total<-2)
        dd+="<td><span>&#9956;</span></td></tr>";
        else if(item.total<0&&item.total>=-2)
        dd+="<td><span>&#9956;</span><span>&#9956;</span></td></tr>";
        else if(item.total<2&&item.total>=0)
        dd+="<td><span>&#9956;</span><span>&#9956;</span><span>&#9956;</span></td></tr>";
        else if(item.total<5&&item.total>=2)
        dd+="<td><span>&#9956;</span><span>&#9956;</span><span>&#9956;</span><span>&#9956;</span></td></tr>";
        else 
        dd+="<td><span>&#9956;</span><span>&#9956;</span><span>&#9956;</span><span>&#9956;</span><span>&#9956;</span></td></tr>";
           $('#revrat').append(dd)
